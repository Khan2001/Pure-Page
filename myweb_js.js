...
function chooseEngine() {
	...
	switch(choice){
		case 1:showEngine('engine1','engine2','engine3','engine4','engine5');break;
		case 2:showEngine('engine2','engine1','engine3','engine4','engine5');break;
		case 3:showEngine('engine3','engine1','engine2','engine4','engine5');break;
		case 4:showEngine('engine4','engine1','engine2','engine3','engine5');break;
		case 5:showEngine('engine5','engine1','engine2','engine3','engine4');break;
	}
}
...
function bigger() {
	...
	//$('hitokoto').innerHTML = url("https://v1.hitokoto.cn/?c=k&encode=text");
}
function smaller() {
...
function searchEngine() {
	...
	if (content) {
		switch(choice){
			case 1:window.open("https://baidu.com/s?wd=" + content);break;
			case 2:window.open("https://www.sogou.com/web?query=" + content);break;
			case 3:window.open("https://cn.bing.com/search?q=" + content);break;
			case 4:window.open("https://www.google.com/search?q=" + content);break;
			case 5:window.open("https://www.so.com/s?q=" + content);break;
		}
	}
}
